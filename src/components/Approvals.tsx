                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-slate-900 shadow-2xl rounded-2xl border border-slate-200 dark:border-slate-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 p-2 transform origin-top-right scale-95 group-hover:scale-100">
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 text-[11px] rounded-xl flex items-center gap-3 transition-all ${sortOption === 'urgency'
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 text-[11px] rounded-xl flex items-center gap-3 mt-1 transition-all ${sortOption === 'date_desc'
                                        ? 'bg-blue-600 text-white font-black shadow-lg shadow-blue-500/20'
                                        : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 text-[11px] rounded-xl flex items-center gap-3 mt-1 transition-all ${sortOption === 'amount_desc'
                                        ? 'bg-blue-600 text-white font-black shadow-lg shadow-blue-500/20'
                                        : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 text-[11px] rounded-xl flex items-center gap-3 mt-1 transition-all ${sortOption === 'amount_asc'
                                        ? 'bg-blue-600 text-white font-black shadow-lg shadow-blue-500/20'
                                        : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold'
                                        }`}
                                >
                        ...
                        processedPayments.map(payment => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`group relative p-3 rounded-xl border transition-all cursor-pointer hover:shadow-lg ${urgency.borderClass} ${urgency.cardBg || ''} ${selectedId === payment.id
                                ...
                                <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 dark:border-slate-800 pb-8">
                                    ...
                                    <div className="flex flex-col items-end gap-2">
                                        <div className="text-right">
                                            ...
                                            <div className={`inline-flex items-center gap-3 px-4 py-2 rounded-2xl border-2 transition-all ${isChecklistComplete
                                                    ...
                                                    {[
                                                        ...
                                                        <div key={item.id} className="flex group transition-all duration-300">
                                                            <button
                                                                ...
                                                                className={`w-14 h-14 border-r border-slate-100 dark:border-slate-800/50 flex items-center justify-center transition-all duration-300 ${checklist[item.id as keyof typeof checklist]
                                                            ...
                                                            <div className={`flex-1 px-5 flex items-center text-xs font-bold uppercase tracking-tight transition-colors duration-300 ${checklist[item.id as keyof typeof checklist]
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center justify-between mb-2 px-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-2 py-1 rounded-lg border transition-all ${checklist.datesApproved
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center justify-between mb-2 px-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-2 py-1 rounded-lg border transition-all ${checklist.proposedDatesApproved
                                                                ? 'bg-emerald-50 border-emerald-200 text-emerald-600'
                                                                : 'bg-white border-slate-200 text-slate-400 hover:border-slate-300'
                                                                }`}
                                                        >
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center justify-between mb-2 px-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-2 py-1 rounded-lg border transition-all ${checklist.observationsApproved
                                                                ? 'bg-emerald-50 border-emerald-200 text-emerald-600'
                                                                : 'bg-white border-slate-200 text-slate-400 hover:border-slate-300'
                                                                }`}
                                                        >
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center justify-between mb-2 px-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-2 py-1 rounded-lg border transition-all ${checklist.amountsApproved
                                                                ? 'bg-emerald-50 border-emerald-200 text-emerald-600'
                                                                : 'bg-white border-slate-200 text-slate-400 hover:border-slate-300'
                                                                }`}
                                                        >
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center justify-between mb-2 px-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-2 py-1 rounded-lg border transition-all ${checklist.proposedAmountApproved
                                                                ? 'bg-emerald-50 border-emerald-200 text-emerald-600'
                                                                : 'bg-white border-slate-200 text-slate-400 hover:border-slate-300'
                                                                }`}
                                                        >
                                                        ...
                                                        {selectedPayment.history && selectedPayment.history.length > 0 ? (
                                                            [...selectedPayment.history].reverse().map((log, idx) => (
                                                                <div key={idx} className="flex items-start gap-4 border-b border-slate-50 dark:border-slate-800 pb-4 last:border-0 last:pb-0 group/log">
                                                                    <div className={`w-2.5 h-2.5 rounded-full mt-1.5 shrink-0 border-2 border-white dark:border-slate-900 shadow-sm ${log.action === 'CREACION' ? 'bg-blue-500' :
                                            ...
                                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                                <div className="flex-1 w-full space-y-2">
                                                    <button
                                                        ...
                                                        className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest transition-all text-sm flex items-center justify-center gap-3 ${isRejecting
                                                ...
                                                <div className="flex-1 w-full space-y-2">
                                                    <button
                                                        ...
                                                        className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest transition-all text-sm flex items-center justify-center gap-3 shadow-2xl ${isChecklistComplete
